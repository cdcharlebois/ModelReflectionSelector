...
(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['ModelReflectionSelector/widget/lib/jquery-1.11.2'], factory);
    } else if (typeof module !== 'undefined' && module.exports) {
        module.exports = factory(require('ModelReflectionSelector/widget/lib/jquery-1.11.2'));
    } else {
        factory(jQuery);
    }
}(function($, undefined) {
                ...
                try {
                    if (this._wrk === null) {
                        this._wrk = window.URL.createObjectURL(
                            new window.Blob(
                                ['self.onmessage = ' + func.toString()], { type: "text/javascript" }
                            )
                        );
                    }
